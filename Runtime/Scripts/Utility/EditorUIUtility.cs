...
public static class EditorUIUtility
{
    ...
    public static void DrawLableWithoutSpace(string labelString, GUISkin skin=null,params GUILayoutOption[] gUILayoutOption)
    {
        ...
        Vector2 size = skin.GetStyle(PackageEditorConstants.label).CalcSize(new GUIContent(labelString));
    ...
    public static void DrawLabel(string label,int fontSize,TextAnchor alignment,GUIStyle style=null,params GUILayoutOption[] gUILayoutOption)
    {
